...
* Use `BOX` select to chose the central vertices and shift them upward to mat the roof angle, kbd:[G] kbd:[Z] 
...
NOTE: 
This is a nice magical incantation to align vertices to an axis, 
